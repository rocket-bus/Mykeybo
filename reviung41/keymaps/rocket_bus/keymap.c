...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_LOWER] = LAYOUT_reviung41(
    LALT_T(KC_TAB),  KC_EXLM,     KC_AT,    KC_HASH,  KC_DLR,    KC_PERC,                KC_P7,    KC_P8,    KC_P9,  KC_PPLS,  KC_PMNS,  KC_PAST,
  ...
  [_RAISE] = LAYOUT_reviung41(
    ...
    _______,  KC_MINS,  KC_EQL,   KC_BSLS,  KC_LBRC,   KC_RBRC,            KC_PGUP,  KC_UNDS,  KC_UP,    KC_LCBR,  KC_RCBR,  KC_RO,
    _______,  KC_ESC,   KC_RGUI,  KC_RALT,  KC_CAPS,   KC_QUOT,            KC_PGDN,  KC_LEFT,  KC_DOWN,  KC_RGHT,  A(KC_F4), KC_CALCULATOR,
                                            _______,   _______,  KC_ENT,  _______,  _______
  ),

  [_ADJUST] = LAYOUT_reviung41(
    RGB_VAI,   RGB_SAI, RGB_HUI,  RGB_MOD,  XXXXXXX,   RGB_TOG,            XXXXXXX,  XXXXXXX,  XXXXXXX,  XXXXXXX, XXXXXXX,  KC_F1,
    RGB_VAD,   RGB_SAD, RGB_HUD,  RGB_RMOD, KC_F7,     KC_F8,              KC_F9,    KC_F10,   KC_F11,   KC_F12,  XXXXXXX,  RESET,
