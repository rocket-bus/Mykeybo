...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  LAYOUT_directional(
      ...
      KC_LSFT,         KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_UP,  LT(1,KC_DEL),
      LT(1,KC_GRV),  MT(MOD_LGUI,KC_APP), KC_LALT, KC_SPC, LT(2,KC_ENT), LT(2,KC_BSPC), KC_APP, KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT
