...
// #define M_ERAISE MACROTAP(UM_ERAISE)   // 「RAISE」キー用のコード
// #define M_HENNUM MACROTAP(UM_HENNUM)   //  「NUMPAD」キー用のコード
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  [_QWERTY] = LAYOUT_directional(
      ...
      NUMPAD,  MT(MOD_LGUI,KC_APP), KC_LALT,  KC_SPC, RAISE, LT(_RAISE,KC_BSPC), KC_APP, KC_RCTL, KC_LEFT, KC_DOWN, KC_RIGHT
  ...
  [_NUMPAD] = LAYOUT_directional(
      ...
      MO(_NUMPAD), KC_APP,      ______,    KC_RO,       MO(_RAISE),    KC_P0,                         KC_PDOT,   KC_PDOT,           KC_HOME, KC_PGDN, KC_END
      ),

  [_LOWER] = LAYOUT_directional(
      KC_GRV, KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,       KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_F11,   KC_F12,  ______,  RESET,
      KC_CAD, KC_F2,      KC_F3,      KC_F4,      KC_F5,      KC_F6,       ______,  KC_P7,   KC_P8,   KC_P9,  KC_PMNS, KC_UP,    KC_PSLS, KC_PAST,
 ...
 */
 ...
 [_RAISE] = LAYOUT_directional(
      KC_GRV, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10, KC_F11, KC_F12, ______, RESET,
      KC_CAD, KC_1, KC_2, KC_3, KC_4, KC_5, KC_6, KC_7, KC_8, KC_9, KC_0, KC_UP, ______, ______,
      ______, KC_F4, KC_F5, KC_F6, KC_F7, KC_F8, KC_F9, KC_F10, KC_F11, KC_F12, KC_LEFT, KC_RIGHT,______,
      ______, KC_F2, KC_F3, KC_F5, KC_F2, ______, ______, ______, ______, ______, ______, ______, KC_PGUP, ______,
...
static bool numpad_pressed = false;
static uint16_t numpad_pressed_time = 0;
...
bool process_record_user(uint16_t keycode, keyrecord_t *record) {
    switch(keycode){
        ...
        case NUMPAD:
          if (record->event.pressed) {
             numpad_pressed = true;
             numpad_pressed_time = record->event.time;
             ...
             update_tri_layer(_NUMPAD, _RAISE, _ADJUST);
              ...
              if (numpad_pressed && (TIMER_DIFF_16(record->event.time, numpad_pressed_time) < TAPPING_TERM)) {
                register_code(KC_GRV); // tapで全角/半角
                unregister_code(KC_GRV);
                }
              numpad_pressed = false;
            }
          return false;
          break;
        ...
        case RAISE:
          if (record->event.pressed) {
             ...
             layer_on(_RAISE);
             update_tri_layer(_RAISE, _NUMPAD, _ADJUST);
             } else {
               layer_off(_RAISE);
               update_tri_layer(_RAISE, _NUMPAD, _ADJUST);

              if (raise_pressed && (TIMER_DIFF_16(record->event.time, raise_pressed_time) < TAPPING_TERM)) {
                register_code(KC_ENT); // tapでEnter
